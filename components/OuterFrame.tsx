...
export const OuterFrame: React.FC<OuterFrameProps> = ({
  ...
  const isInputPhase = (tokenCount?.output ?? 0) === 0;
      ...
      <div className="main-container">
        ...
        <div className="outer-header">
          ...
          <div className="outer-caption-row">
            ...
            {tokenCount && (
              <span className="token-display flex items-center gap-2 select-none" aria-live="polite" aria-atomic="true">
                <span className={phaseClass}>
                  <span className="material-symbols-outlined token-icon mr-1" aria-hidden="true">
